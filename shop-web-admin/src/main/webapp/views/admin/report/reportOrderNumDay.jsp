	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class=""><a href="${ctxa}/report/orderNum/countMonthNum.do"> <i class="fa fa-user"></i> ${fns:fy("按月统计")}</a></li>
			</ul>
		</header>
		<!-- panel-body开始 -->		 
		<div class="panel-body">
			...
			<div class="row" style="margin-bottom:10px">
				...
				<form action="${ctxa}/report/orderNum/countDayNum.do" method="get" id="searchForm">
					<div class="col-sm-3">
					</div>
					<div class="col-sm-2">
					</div>
