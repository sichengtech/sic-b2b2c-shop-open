	...
	<section class="panel">
		...
		<div class="panel-body">
			...
			<div class="alert alert-info alert-block fade in ${cookie.fdp_operationTips.value=='0'?'point_hidden':''}" id="point">
				<h5>${fns:fy("操作提示")}</h5>
				<ul>
					<li>${fns:fy("报表管理.新增店铺.操作提示5")}</li>
					<li>${fns:fy("报表管理.新增店铺.操作提示6")}</li>
				</ul>
			</div>
			<!-- 提示 end --> 
			...
			<div class="row" style="margin-bottom:10px">
				...
				<form action="${ctxa}/report/store/countMonthNum.do" method="get" id="searchForm">
					<div class="col-sm-3">
					</div>
					<div class="col-sm-2">
					</div>
				...
				<tbody>
					<c:forEach items="${list}" var="report" varStatus="status">
						<tr>
							...
							<td>
								<a class="btn btn-info btn-sm" href="${ctxa}/store/store/list.do?beginCreateDate=${thisMonthStart}&endCreateDate=${thisMonthEnd}">
