	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class=""><a href="${ctxa}/report/storeSale/countWeekNum.do"> <i class="fa fa-user"></i> ${fns:fy("按周统计")}</a></li>
		...
		<div class="panel-body">
			...
			<div class="row" style="margin-bottom:10px">
				...
				<form action="${ctxa}/report/storeSale/countDayNum.do" method="get" id="searchForm">
					<div class="col-sm-3">
					</div>
					<div class="col-sm-2">
					</div>
