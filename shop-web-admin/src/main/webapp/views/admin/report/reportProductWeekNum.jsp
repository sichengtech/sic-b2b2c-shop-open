	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class=""><a href="${ctxa}/report/product/countMonthNum.do"> <i class="fa fa-user"></i> ${fns:fy("按月统计")}</a></li>
			</ul>
		</header>
		...
		<div class="panel-body">
			...
			<div class="row" style="margin-bottom:10px">
				...
				<form action="${ctxa}/report/product/countWeekNum.do" method="get" id="searchForm">
