	...
	<section class="panel">
		...
		<div class="panel-body">
			...
			<div class="alert alert-info alert-block fade in ${cookie.fdp_operationTips.value=='0'?'point_hidden':''}" id="point">
				<h5>${fns:fy("操作提示")}</h5>
				<ul>
					<li>${fns:fy("报表管理.会员购买.操作提示1")}</li>
					<li>${fns:fy("报表管理.会员购买.操作提示2")}</li>
				</ul>
			</div>
			<!-- 提示 end --> 
			...
			<div class="row" style="margin-bottom:10px">
				...
				<form action="${ctxa}/report/userPurchase/countDayNum.do" method="get" id="searchForm">
					<div class="col-sm-3">
					</div>
					<div class="col-sm-2">
					</div>
