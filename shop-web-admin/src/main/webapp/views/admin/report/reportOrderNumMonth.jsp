...
<body>
	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			<h4 class="title">${fns:fy("下单数量")}</h4>
			<%@ include file="../include/functionBtn.jsp"%>
			<ul class="nav nav-tabs pull-right">
				<li class=""><a href="${ctxa}/report/orderNum/countDayNum.do""> <i class="fa fa-user"></i> ${fns:fy("按天统计")}</a></li>
				<li class=""><a href="${ctxa}/report/orderNum/countWeekNum.do"> <i class="fa fa-user"></i> ${fns:fy("按周统计")}</a></li>
		...
		<div class="panel-body">
			...
			<div class="alert alert-info alert-block fade in ${cookie.fdp_operationTips.value=='0'?'point_hidden':''}" id="point">
				<h5>${fns:fy("操作提示")}</h5>
				<ul>
					<li>${fns:fy("报表管理.下单数量.操作提示1")}</li>
					<li>${fns:fy("报表管理.下单数量.操作提示2")}</li>
				</ul>
			</div>
			<!-- 提示 end --> 
			...
			<div class="row" style="margin-bottom:10px">
				...
				<form action="${ctxa}/report/orderNum/countMonthNum.do" method="get" id="searchForm">
					<div class="col-sm-3">
					</div>
					<div class="col-sm-2">
					</div>
