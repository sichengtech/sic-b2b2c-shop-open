...
<html lang="zh-CN">
<head>
<title>${fns:fy("退款金额-按月统计")}退款金额-按月统计</title>
	...
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class=""><a href="${ctxa}/report/refundAmount/countWeekNum.do"> <i class="fa fa-user"></i> ${fns:fy("按周统计")}</a></li>
		...
		<div class="panel-body">
			...
			<div class="alert alert-info alert-block fade in ${cookie.fdp_operationTips.value=='0'?'point_hidden':''}" id="point">
				<h5>${fns:fy("操作提示")}</h5>
				<ul>
					<li>${fns:fy("报表管理.退款金额.操作提示1")}</li>
					<li>${fns:fy("报表管理.退款金额.操作提示2")}</li>
				</ul>
			</div>
			<!-- 提示 end --> 
			...
			<div class="row" style="margin-bottom:10px">
				...
				<form action="${ctxa}/report/refundAmount/countMonthNum.do" method="get" id="searchForm">
					<div class="col-sm-3">
					</div>
					<div class="col-sm-2">
					</div>
