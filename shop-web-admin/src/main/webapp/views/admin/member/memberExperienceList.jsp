...
<!-- 业务js -->
<script type="text/javascript" src="${ctx}/views/admin/member/memberExperienceList.js"></script>
</head>
<body>
	<!-- panel start -->
	<section class="panel">
		<header class="panel-heading custom-tab tab-right ">
			<h4 class="title">经验值明细</h4>
					...
					<form id="" method="get"> 
						<div class="modal-body form-horizontal adminex-form">
							<div class="form-group"> 
								<label class="col-sm-3 control-label text-right">添加时间：</label>
								<div class="col-sm-4">
