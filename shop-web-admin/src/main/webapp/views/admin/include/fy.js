(function () {
    ...
    fy.getMsg=function (key, ...rest) {
        ...
        var oldDate=localStorage.getItem("adminFyDate");
        if(typeof(oldDate)!="undefined" && oldDate!=null){
            differenceDate=(curDate-oldDate)/(1000*60*60);
        }
        if (differenceDate>=10 || localStorage.getItem("adminFycnMap") == null || localStorage.getItem("adminFyenMap") == null || localStorage.getItem("defaultLocale") == null) {
            $.ajax({
                type: "GET",
                ...
                success: function (data) {
                    ...
                    localStorage.setItem("adminFyDate",new Date().getTime());
                }
            });
        }
