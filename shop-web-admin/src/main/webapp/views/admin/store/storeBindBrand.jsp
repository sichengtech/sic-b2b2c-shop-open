...
<!-- 业务js -->
<script type="text/javascript" src="${ctx}/views/admin/store/storeBindBrand.js"></script>
<style type="text/css">
	...
	.no{height: 135px;padding-left: 246px;padding-top: 48px;}
</style>
</head>
<body style="background: #f5f5f5;">
	...
	<div id="brand">
		<ul class="prompt">
			<li>${fns:fy("店铺管理.店铺管理.操作提示12")}</li>
			<li>${fns:fy("店铺管理.店铺管理.操作提示13")}</li>
			<li>${fns:fy("店铺管理.店铺管理.操作提示14")}</li>
		</ul>
		<div class="brandDiv">
			<span>${fns:fy("已选品牌")}:</span>
			<div class ="selectedClass">
				<c:forEach var="productBrand" items="${selectedStoreBrand}">
					<div>
		...
		<div class="brandDiv" style="${unselectedStoreBrand.size()==0?'display:none':'display:block'}">
			<div class ="unselectedClass">
				<c:forEach var="productBrand" items="${unselectedStoreBrand}">
					<div class="class_div">
						<input type="hidden" value="${productBrand.brandId}" class="brandId">
		...
		<div class="brandDiv" style="${unselectedStoreBrand.size()==0?'display:block':'display:none'}">
