    ...
    $(".bindBrand").click(function () {
        ...
        layer.open({
            ...
            yes: function (index, layero) {
                ...
                location.href = ctxa + '/store/store/storeBindBrand.do?storeId=' + storeId + '&brandIds=' + brandIds;
            }
        });
    });
    ...
    $(".bindCommission").click(function () {
        ...
        layer.open({
            ...
            yes: function (index, layero) {
                ...
                location.href = ctxa + "/store/store/storeInitCommissionSave.do?storeId=" + storeId + "&commission=" + commission;
            }
        });
    });
        ...
        layer.open({
            ...
            yes: function (index, layero) {
                ...
                if (markingImgPath == null || markingImgPath == '') {
                    layer.msg(fy.getMsg('打标失败') + ':' + fy.getMsg('没有上传图片'));
                    return false;
                }
                setTimeout(function () {
                    //如果1.5秒内未完成操作，则给出请等待的提示
                ...
                location.href = ctxa + "/store/store/storeInitMarkingSave.do?storeId=" + storeId + "&markingImgPath=" + markingImgPath;
            }
        });
    });
