		...
		<div class="panel-body">
			...
			<div class="tab-content" style="margin-top:15px;">
				<div class="tab-pane active" id="home-3">
					<form class="cmxform form-horizontal adminex-form" id="inputForm" action="${ctxa}/settlement/settlementPayWay/alipay2.do" method="post">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess"><font color="red">*</font> 支付宝账号&nbsp;:</label>
							<div class="col-sm-5">
								<input type="text" name="k1"  maxlength="64" class="form-control input-sm" value="${settlementPayWay.k1}"/>
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess"><font color="red">*</font> 支付宝交易安全校验码&nbsp;:</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="inputSuccess"><font color="red">*</font> 支付宝合作者身份id(partner ID) &nbsp;:</label>
							<div class="col-sm-5">
