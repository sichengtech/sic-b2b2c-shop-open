...
/**
  ...
  */
@Controller
@RequestMapping(value = "${adminPath}/report/store")
public class ReportStoreController extends BaseController {
    ...
    public void get(Long id, Model model) {
        String menu3 = "010602";//请修改为正确的三级菜单编号
    ...
    /**
      ...
      * @return
     */
    @RequiresPermissions("report:store:view")
    ...
    public String countDayNum(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        List<Map<String, Object>> lList = reportDao.report3(lMap);
        ...
        List<Map<String, Object>> tList = reportDao.report3(tMap);
        ...
        return "admin/report/reportStoreDayNum";
    }
    ...
    public String countWeekNum(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        lMap.put("dbType$", Global.getConfig("jdbc.type"));
        List<Map<String, Object>> lList = reportDao.report4(lMap);
        ...
        tMap.put("dbType$", Global.getConfig("jdbc.type"));
        List<Map<String, Object>> tList = reportDao.report4(tMap);
        ...
        return "admin/report/reportStoreWeekNum";
    }
    ...
    public String countMonthNum(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "admin/report/reportStoreMonthNum";
    }
}
