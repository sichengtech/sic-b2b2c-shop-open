...
/**
  ...
  */
@Controller
@RequestMapping(value = "${adminPath}/report/orderAmount")
public class ReportOrderAmountController extends BaseController {
    ...
    public void get(Long id, Model model) {
        String menu3 = "010606";//请修改为正确的三级菜单编号
    ...
    /**
      ...
      * @return
     */
    @RequiresPermissions("report:orderAmount:view")
    ...
    public String countDayNum(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        List<Map<String, Object>> lList = reportDao.report8(lMap);
        ...
        List<Map<String, Object>> tList = reportDao.report8(tMap);
        ...
        return "admin/report/reportOrderAmountDayNum";
    }
    ...
    public String countWeekNum(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        lMap.put("dbType$", Global.getConfig("jdbc.type"));
        List<Map<String, Object>> lList = reportDao.report9(lMap);
        ...
        tMap.put("dbType$", Global.getConfig("jdbc.type"));
        List<Map<String, Object>> tList = reportDao.report9(tMap);
        ...
        model.addAttribute("searchTime", searchTime);
        return "admin/report/reportOrderAmountWeekNum";
    }
    ...
    public String countMonthNum(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        //回显搜索条件
        model.addAttribute("searchTime", searchTime);
        return "admin/report/reportOrderAmountMonthNum";
    }
}
