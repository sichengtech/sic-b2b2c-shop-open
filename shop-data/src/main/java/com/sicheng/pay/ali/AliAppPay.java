 ...
 *
 * @author zjl
 * @version 2019年10月10日 下午6:55:32
 */
@Service("aliAppPay")
public class AliAppPay implements ShopPay {
    ...
    private final String PAY_MAY_NUM = "ali_app";//支付方式编号
    ...
    public static ShopPay getInstance() {
        if (shopPay == null) {
            synchronized (AliAppPay.class) {
                if (shopPay == null) {
                    shopPay = new AliAppPay();
                }
            }
        }
        return shopPay;
