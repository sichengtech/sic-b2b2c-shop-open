 ...
 * @version 2017-04-11
 */
public class StoreCategoryBase<T> extends TreeEntity<T> {

    private static final long serialVersionUID = 1L;
    private Long storeCategoryId;           // 主键
    private Long storeId;                   // 关联(店铺表)
    private Integer cateLevel;              // 分类层级
    ...
    public StoreCategoryBase() {
        super();
    }

    public StoreCategoryBase(Long id) {
        super(id);
