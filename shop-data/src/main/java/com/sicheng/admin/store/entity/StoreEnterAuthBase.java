 ...
 * @version 2017-08-04
 */
public class StoreEnterAuthBase<T> extends DataEntity<T> {

    private static final long serialVersionUID = 1L;
    private Long enterId;                   // 主键(卖家表，入驻申请，店铺表，店铺二级域名用1个id)
    private String status;                  // 入驻信息完善后才有值 审核状态：10一审待审核、20一审审核成功、30一审审核不通过、40二审待审核、50二审审核通过、60二审核不通过 70 入驻信息更改后审核中、  80入驻信息更改后审核通过、90入驻信息更改后审核不通过
    ...
    public StoreEnterAuthBase() {
        super();
    }

    public StoreEnterAuthBase(Long id) {
        super(id);
        this.enterId = id;
    }
    ...
    /**
     * getter status(入驻信息完善后才有值 审核状态：10一审待审核、20一审审核成功、30一审审核不通过、40二审待审核、50二审审核通过、60二审核不通过 70 入驻信息更改后审核中、  80入驻信息更改后审核通过、90入驻信息更改后审核不通过)
     */
    ...
    /**
     * setter status(入驻信息完善后才有值 审核状态：10一审待审核、20一审审核成功、30一审审核不通过、40二审待审核、50二审审核通过、60二审核不通过 70 入驻信息更改后审核中、  80入驻信息更改后审核通过、90入驻信息更改后审核不通过)
     */
