 ...
 * @version 2017-04-11
 */
public class StoreAlbumBase<T> extends DataEntity<T> {

    private static final long serialVersionUID = 1L;
    private Long albumId;                   // 主键
    ...
    public StoreAlbumBase() {
        super();
    }

    public StoreAlbumBase(Long id) {
        super(id);
        this.albumId = id;
    }
