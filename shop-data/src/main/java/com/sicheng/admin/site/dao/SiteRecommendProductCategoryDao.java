 ...
 */
@MyBatisDao
public interface SiteRecommendProductCategoryDao extends CrudDao<SiteRecommendProductCategory> {
     ...
     * @return
     */
    List<String> queryProductCategoryRecommend(Long categoryId);
}