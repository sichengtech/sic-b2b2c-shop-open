...
/**
 * 提现 Entity 子类，请把你的业务代码写在这里
 *
 * @author 范秀秀
 * @version 2017-02-07
 */
public class SettlementWithdrawals extends SettlementWithdrawalsBase<SettlementWithdrawals> {

    private static final long serialVersionUID = 1L;

    public SettlementWithdrawals() {
        super();
    }

    public SettlementWithdrawals(Long id) {
        super(id);
    }
    ...
    //填充 xxx,把1+N改成1+1
    public static void fillUserMain(List<SettlementWithdrawals> list) {
    ...
    //填充 xxx,把1+N改成1+1
    public static void fillSettlementPayWay(List<SettlementWithdrawals> list) {
    ...
    //填充 xxx,把1+N改成1+1
    public static void fillUser(List<SettlementWithdrawals> list) {
