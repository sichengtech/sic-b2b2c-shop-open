 ...
 */
@MyBatisDao
public interface AccountPlatformSnDao extends CrudDao<AccountPlatformSn> {
	 ...
	 * 支付手续费用总和
	 */
	public BigDecimal payCommissionTotal(@Param(value = "list") List<String> list);
	
	/**
	 * 支付退回手续费用总和
	 */
	public BigDecimal refundCommissionTotal(@Param(value = "list") List<String> list);
