...
/**
 * 账户绑卡表 Entity 子类，请把你的业务代码写在这里
 * @author cl
 * @version 2018-07-14
 */
public class AccountTiedCard extends AccountTiedCardBase<AccountTiedCard> {
	
	private static final long serialVersionUID = 1L;
	public AccountTiedCard() {
		super();
	}

	public AccountTiedCard(Long id){
		super(id);
	}
	...
	private UserMain userMain;	//会员信息
