 ...
 */
@MyBatisDao
public interface TradeReturnOrderVoucherDao extends CrudDao<TradeReturnOrderVoucher> {
    //请在这里增加你自己的DAO层方法
     ...
     * @return
     */
    List<TradeReturnOrderVoucher> selectByReturnOrderIdIn(@Param(value = "list") List<Object> list);
}