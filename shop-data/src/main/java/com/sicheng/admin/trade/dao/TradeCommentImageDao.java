 ...
 */
@MyBatisDao
public interface TradeCommentImageDao extends CrudDao<TradeCommentImage> {
    //请在这里增加你自己的DAO层方法
     ...
     *
     * @param list commentId集合
     * @return
     */
    List<TradeCommentImage> selectByCommentIdIn(@Param(value = "list") List<Object> list);
}