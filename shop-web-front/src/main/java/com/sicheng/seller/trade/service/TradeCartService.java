...
//    private TradeOrderService tradeOrderService;
    ...
    public List<TradeCart> selectBySkus(UserMember userMember, Long pId, String skuMsg, String type) {
        ...
        if (userMember == null) {
            userMember = SsoUtils.getUserMain().getUserMember();
        }
        ...
        for (int i = 0; i < skus.length; i++) {
            ...
            //收货地址
            List<MemberAddress> addressList = memberAddressService.selectByWhere(new Wrapper().and("u_id=", userMember.getUId()).orderBy("is_default desc"));
            ...
            if (addressList.isEmpty()) {
                ...
                TradeOrderService tradeOrderService= SpringContextHolder.getBean(TradeOrderService.class);
