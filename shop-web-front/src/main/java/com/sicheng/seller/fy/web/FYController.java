 ...
 */
package com.sicheng.seller.fy.web;
 ...
 */
@Controller
@RequestMapping(value = "${sellerPath}/fy")
public class FYController extends BaseController {
    ...
    public Map<String, Object> poperties() {
        Map<String, String> cnMap = FYUtils.getFYProperties("msg/seller_zh_CN.properties");
        Map<String, String> enMap = FYUtils.getFYProperties("msg/seller_en_US.properties");
