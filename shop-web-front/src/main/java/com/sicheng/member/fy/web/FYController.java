 ...
 */
package com.sicheng.member.fy.web;
 ...
 */
@Controller
@RequestMapping(value = "${memberPath}/fy")
public class FYController extends BaseController {
    ...
    public Map<String, Object> poperties() {
        Map<String, String> cnMap = FYUtils.getFYProperties("msg/member_zh_CN.properties");
        Map<String, String> enMap = FYUtils.getFYProperties("msg/member_en_US.properties");
