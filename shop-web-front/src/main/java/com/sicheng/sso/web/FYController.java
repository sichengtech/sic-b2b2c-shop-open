 ...
 */
@Controller
@RequestMapping(value = "${ssoPath}/fy")
public class FYController extends BaseController {
    ...
    public Map<String, Object> poperties() {
        Map<String, String> cnMap = FYUtils.getFYProperties("msg/sso_zh_CN.properties");
        Map<String, String> enMap = FYUtils.getFYProperties("msg/sso_en_US.properties");
