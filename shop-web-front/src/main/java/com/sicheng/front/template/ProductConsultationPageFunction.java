...
/**
 * <p>
 * 标题: 自定义函数，ProductConsultationPageFunction函数
 * </p>
 * <p>
 * 描述: 根据pid获取一个咨询列表,带分页
 * </p>
 * <p>
 ...
 */
public class ProductConsultationPageFunction implements Function {

    public static final String PID = "pid";

    public Page<TradeConsultation> call(Object[] args, Context ctx) {
        // 处理标签的入参数，json参数
        Map<String, Object> tagParamMap = TagUtils.getTagParamMap(args);
        Long pid = TagUtils.getLong(tagParamMap, PID);
        if (pid == null) {
            return new Page<TradeConsultation>();
        }
        ...
        page = service.selectByWhere(page, new Wrapper(tradeConsultation));
        return page;
    }
}