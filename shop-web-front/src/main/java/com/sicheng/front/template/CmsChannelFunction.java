 ...
 *
 * @author cailong
 * @version 2017年5月25日 下午3:33:43
 */
public class CmsChannelFunction implements Function {

    private static final String ID = "id";//栏目id
    private static final String NAME = "name";//栏目名称
    ...
    public Object call(Object[] args, Context ctx) {
        ...
        c.setId(id);
        c.setName(name);
        List<Category> categoryList = categoryService.selectByWhere(new Wrapper(c));
