 ...
 *
 * @author cailong
 * @version 2017年5月25日 下午4:05:58
 */
public class CmsChannelListFunction implements Function {
    ...
    public Object call(Object[] args, Context ctx) {
        ...
        Page<Category> categoryPage = categoryService.selectByWhere(new Page<Category>(1, limit, limit), wrapper);
