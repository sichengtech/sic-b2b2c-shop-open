 ...
 *
 * @author cailong
 * @version 2017年5月18日 下午6:40:05
 */
public class DictLabelFunction implements Function {

    private static String VALUE = "value";//值
    private static String TYPE = "type";//字典类型

    public Object call(Object[] args, Context ctx) {
        // 处理标签的入参数，json参数
        Map<String, Object> tagParamMap = TagUtils.getTagParamMap(args);
        String value = TagUtils.getString(tagParamMap, VALUE);
