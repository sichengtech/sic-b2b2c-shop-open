...
/**
 * <p>
 * 标题: 自定义函数，ProductCommentPageFunction函数
 * </p>
 * <p>
 * 描述: 根据pid获取一个商品评论列表,带分页
 * </p>
 * <p>
 ...
 */
public class ProductCommentPageFunction implements Function {

    public static final String PID = "pid";
    public static final String GRADE = "grade";

    public Page<TradeComment> call(Object[] args, Context ctx) {
        // 处理标签的入参数，json参数
        ...
        page = service.selectByWhere(page, new Wrapper(comment));
        return page;
    }
}