...
<body>
	<div class="main-center">
		<dl>
			...
			<dd class="myform">
				<c:if test="${empty userRepairShop.authType}">
					<div class="sui-msg msg-tips msg-block" style="margin-top: 10px;">
						<div class="msg-con" style="height: 125px;padding-top: 90px;font-size: 20px;padding-left: 333px;">
							${fns:fy('你还没填写,请点击编辑！')}
							<a href="${ctxm}/upgrade/openDoorStore/save2.htm">${fns:fy('编辑')}</a>
						</div>
						<s class="msg-icon" style="padding-top: 86px;font-size: 28px;padding-left: 297px"></s>
					</div>
				</c:if>
				<c:if test="${fn:trim(userRepairShop.authType)=='0'}">
					<div class="sui-msg msg-tips msg-block" style="margin-top: 10px;">
				...
				<c:if test="${fn:trim(userRepairShop.authType)=='1'}">
					<div class="sui-msg msg-tips msg-block" style="margin-top: 10px;">
						<div class="msg-con" style="height: 125px;padding-top: 90px;font-size: 20px;padding-left: 333px;">
							${fns:fy('恭喜您，您已经是门店用户！')}
							<a href="${ctxm}/upgrade/openDoorStore/save2.htm">${fns:fy('编辑')}</a>
				...
				<c:if test="${fn:trim(userRepairShop.authType)=='2'}">
					<div class="sui-msg msg-tips msg-block" style="margin-top: 10px;">
