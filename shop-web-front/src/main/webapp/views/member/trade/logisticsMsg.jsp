								...
								<div class="logisticsMess">
									<c:forEach items="${resultMap['Traces']}" var="trace" varStatus="traceIndex">
										<div class="trace">
											...
											<p style="margin-bottom:0px;">${trace['AcceptTime']}</p>
										</div>
									</c:forEach>
								</div>
							</c:if>
