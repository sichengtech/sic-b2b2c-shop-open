...
<html lang="zh-CN">
<head>
<title>${fns:fy('绑定安全手机')}</title>
<meta name="keywords" content=""/>
<meta name="description" content=""/>
<meta name="decorator" content="ssoLeft"/>
<!-- 业务js -->
<script src="${ctx}/views/sso/user/bindingMobile.js" type="text/javascript"></script>
<style type="text/css">
		...
		<dl>
			...
			<dd>
				<div class="infomain sui-form form-horizontal">
					...
					<form id="inputForm" class="form-signin sui-form form-horizontal" action="${ctxsso}/accountSecurity/bindingMobile2.htm" method="post">
						<div class="control-group">
							<label class="control-label">${fns:fy('手机号：')}</label>
							<div class="controls">
								<input type="text" id="mobile" name="mobile" value="${userMain.mobile}" class="input-xlarge input-xfat" placeholder="${fns:fy('输入手机号')}" style="width: 261px;">
								<div class="sui-msg msg-tips msg-naked">
									<div class="msg-con">${fns:fy('安全手机')}</div>
									<s class="msg-icon"></s>
								</div>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="smsVerification" name="smsVerification" class="input-xfat" placeholder="${fns:fy('输入动态码')}">
								<button type="button" id="smsSender" class="sui-btn input-xfat">${fns:fy('发送动态码')}</button>
								<div class="sui-msg msg-tips msg-naked">
