	...
	<div class="sui-pagination pagination-large">
		 <ul>
			...
			<%} else {// 如果不是首页,"上一页"可点击   pageURL+prev%>
				<li class="next"><a href='<%=(page_inner.getPageURL()+page_inner.getPrev())%>'>«${fns:fy('上一页')}</a></li>
			<%}
			...
			<%} else {// 如果不是尾页,"下一页"可点击%>
				<li class="next"><a href='<%=(page_inner.getPageURL()+page_inner.getNext()) %>'>${fns:fy('下一页')}»</a></li>
			<%}%>
		 </ul>
		 <div>
			 <span>${fns:fy('共')}&nbsp;&nbsp;${page.totalPage}&nbsp;&nbsp;${fns:fy('页')}&nbsp;</span>
			 <span>${fns:fy('到')}<input id="iptPageTxt" type="text" class="page-num" href="${page.pageURL}" value="${page.pageNo}"
