...
<style type="text/css">
	.purchase-order-item textarea{padding: 5px;background-color: #f9f6f600}
	.sui-msg.msg-block {margin: 10px !important;}
</style>
</head>
<body>
    <div class="main-content clearfix purchase-order-item" style="overflow:visible">
        <div class="main-center">
            <dl class="box">
                <!-- <dt>
                    <div class="position"><span>当前位置:</span><span>会员中心</span> &gt; <span>供采管理</span> &gt; 订单详情</div>
                    <i class="sui-icon icon-tb-list"></i> 订单详情</span>
                ...
                <dd class="clearfix ml10 mr10 mt10">
                    ...
                    <table class="sui-table table-bordered-simple">
                        ...
                        <tbody id="tbody">
                            ...
                            <tr>
                            	<td width="15%">${purchaseTradeOrderItem.name}</td>
                            	<td width="15%">${purchaseTradeOrderItem.model}</td>
                            	<td width="10%">${purchaseTradeOrderItem.brand}</td>
                            	<td width="10%">${purchaseTradeOrderItem.amount}${purchaseTradeOrderItem.unit}</td>
                            	<td width="10%">${purchaseTradeOrderItem.priceRequirement}</td>
                            	<td width="10%">${purchaseTradeOrderItem.offerPrice}元</td>
                            	<td width="15%">
                            		<textarea rows="2" cols="20"  disabled="disabled">${purchaseTradeOrderItem.purchaseRemarks}</textarea>
                            	</td>
                            	<td width="15%">
